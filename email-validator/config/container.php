...
use App\Infrastructure\Database\Repository\PostgresJobRepository;
use App\Infrastructure\Database\Connection as DatabaseConnection;
...
return [
    ...
    EnqueueEmailValidationUseCase::class => create(EnqueueEmailValidationUseCase::class)
        ->constructor(
            ...
            get(JobRepositoryInterface::class),
        ),
    ...
    PDO::class => factory([DatabaseConnection::class, 'connect']),

    JobRepositoryInterface::class => get(PostgresJobRepository::class),

    PostgresJobRepository::class => create(PostgresJobRepository::class)
