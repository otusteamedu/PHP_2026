...
use App\Application\ValidateEmailsUseCase;
...
class Container
{
    ...
    private function validateEmailsUseCase(): ValidateEmailsUseCase
    {
        return new ValidateEmailsUseCase($this->emailValidator());
    }
