...
| Запрос | Индекс | План на 10000 строк (ms) | План на 10 млн строк (ms) | План на 10 млн строк с индексами | Тип скана |
|--------|--------|--------------------------|---------------------------|----------------------------------|-----------|
| Выбор всех фильмов| idx_screenings_starts_at | 0.111 | 106.001 | 0.147 | Index Scan |
| Подсчет проданных билетов| idx_tickets_screening_status | 12.593 | 2124.736 | 1902.679 | Seq Scan |
| Формирование афиши | idx_screenings_movie_id_starts_at | 1.167 | 8.163 | 0.497 | Index Scan |
| Поиск прибыльных фильмов | idx_tickets_order_id_paid | 44.646 | 15644.925 | 14831.533 | Parallel Seq Scan |
| Сформировать схему зала | idx_tickets_screening_seat_status| 20.345 | 88354.652 | 85841.436 | Seq Scan |
| Вывести диапазон цены за билет| idx_tickets_profit | 0.326 | 1.259 | 0.400 | Index Scan |
