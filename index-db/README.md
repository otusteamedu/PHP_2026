...
[![Открыть в полном размере](assets/2.png)](assets/2.png)
...
[![Открыть в полном размере](assets/3.png)](assets/3.png)

![Список редко используемых индексов](assets/1.png)

[![Открыть в полном размере](assets/1.png)](assets/1.png)
